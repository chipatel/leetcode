...
/******************************************************************************
 * Compilation: javac Interval.java Execution: java Interval Dependencies: StdOut.java
 * 
...
/**
 * The {@code Interval} class represents a one-dimensional interval. The interval is
 * <em>closed</em>—it contains both endpoints. Intervals are immutable: their values cannot be
 * changed after they are created. The class {@code Interval} includes methods for checking whether
